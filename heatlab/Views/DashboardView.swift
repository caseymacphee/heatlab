            ...
            VStack(spacing: 20) {
                ...
                if isLoading {
                    ...
                    VStack(spacing: 16) {
                        ...
                        Text("Ready to Track Your Heat?")
                            .font(.title3.bold())
                        
                        Text("Start a session on your Apple Watch to begin tracking your hot yoga practice.")
                            .font(.subheadline)
                            .foregroundStyle(.secondary)
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Your Apple Watch will track heart rate, calories, and duration. After each session, set the room temperature to help build your personal baseline.")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
                .padding()
